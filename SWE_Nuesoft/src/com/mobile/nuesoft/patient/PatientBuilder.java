...
public class PatientBuilder {
	...
	public PatientObj build() {
		return new PatientObj(id, firstName, lastName, gender, race, religion, ethnicGroup, languages, medicationCurrent, medicationPrevious, medicalEncounters, tests, maritalStatus);
	}
	...
	public class PatientObj implements Serializable {
		...
		public String toString() {
			...
			results += "Name: " + this.getFIRST_NAME() + " " + this.getLAST_NAME() + "\n";
